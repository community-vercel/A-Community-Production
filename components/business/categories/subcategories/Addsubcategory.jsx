...
const categoryOptions = Array.isArray(categories) ? categories.map((cat) => ({
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-5 p-6 md:p-8 bg-white shadow-lg rounded-lg space-y-6 max-w-2xl mx-auto">
 <h2 className="text-center text-xl font-semibold text-gray-800 mb-6">
   Add Sub-Category
    ...
    <div className="flex justify-end mt-6">
      <button
        type="submit"
        className="w-full md:w-auto rounded-full uppercase shadow-lg bg-primary text-white text-sm font-semibold py-4 px-6 hover:bg-primary-dark transition duration-300 ease-in-out transform hover:scale-105"
      >
        Add
      </button>
    </div>
