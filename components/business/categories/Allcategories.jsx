...
const AllCategories = () => {
  ...
  const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Categories", href: "/business/categories/allcategories" },
  ];

  return (
    <div>
      <h1 className="text-5xl font-extrabold mb-8 text-center mt-5 tracking-wide">
        Explore Our Categories
      </h1>
      <Breadcrumb items={breadcrumbItems} />

      {loading && <Loader />}
      <div className="px-0 py-2 flex gap-x-3 gap-y-5 flex-wrap">
        {categories.map((category) => (
      <div key={category.slug} className="flex-[170px] lg:flex-grow-0 lg:w-[19%] lg:flex-[19%] bg-white p-3 rounded-xl">
