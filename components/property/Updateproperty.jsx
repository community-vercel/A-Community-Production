...
const Updateproperty = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      // }
      // const tagsString = tags.map(tag => tag.tag?tag.tag:tag).join(","); // Extract tag names and join them
                        ...
                        <div className="flex flex-col gap-3">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setImagesSelected([...imagesSelected, ...Array.from(e.target.files)]);
                            }}
                            className="hidden"
                            type="file"
                            name="images"
