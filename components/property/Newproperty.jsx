...
import { house, automotive, org } from "@/assets";
...
const Newproperty = ({ initialPropertyData }) => {
  ...
  const images = [
    house, // Using the imported image directly
    automotive, // Add different images if available
    org, // Add different images if available
  ];
  ...
  const metadata = initialPropertyData
    ...
    : {
      ...
      const constructBreadcrumbItems = () => {
        ...
        const currentCategory = property && property.slug === params.slug ? property: null;
        console.log("Currenet category",currentCategory)
        if (currentCategory) {
          breadcrumbItems.push({ label: currentCategory.name, href: `/property/allproperties/${currentCategory.slug}` }); // Link to the current category
      ...
      <div>
        {loading ? (
          ...
          <div>
            ...
            {/* Adjusted color and height for better visibility */}
              ...
              <div className="flex flex-col lg:flex-row gap-4 mt-[-15.5px]">
                <div className="relative w-full mt-4 overflow-hidden">
                  <Image
                    ...
                    src={
                      serverurl + "media/" + property.images[currentImageIndex]
                    }
                ...
                {/* Right side: Price and Contact Form */}
                    ...
                    <ul className="space-y-2">
                      ...
                      <li>
                        <Link
                          ...
                          className="text-blue-500 hover:underline"
                        >
                          7 Marla Houses for sale in Islamabad
                        </Link>
                      </li>
                      <li>
                        <Link
                          ...
                          className="text-blue-500 hover:underline"
                        >
                          7 Marla Houses for sale in I-10
                        </Link>
                      </li>
                    </ul>
                  </div>
          ...
          <p className="text-gray-500">No property details available.</p> // Fallback message
        )}
      </div>
    </>
  );
